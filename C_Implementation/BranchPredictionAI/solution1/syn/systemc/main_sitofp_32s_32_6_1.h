...
// ==============================================================
#ifndef __main_sitofp_32s_32_6_1__HH__
#define __main_sitofp_32s_32_6_1__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(main_sitofp_32s_32_6_1) {
    ...
    SC_CTOR(main_sitofp_32s_32_6_1):  ACMP_sitofp_U ("ACMP_sitofp_U") {
