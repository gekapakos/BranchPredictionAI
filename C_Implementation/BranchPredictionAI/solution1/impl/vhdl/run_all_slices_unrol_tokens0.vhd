...
entity run_all_slices_unrol_tokens0_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 42
...
architecture rtl of run_all_slices_unrol_tokens0_rom is 
...
entity run_all_slices_unrol_tokens0 is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of run_all_slices_unrol_tokens0 is
    component run_all_slices_unrol_tokens0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    run_all_slices_unrol_tokens0_rom_U :  component run_all_slices_unrol_tokens0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
