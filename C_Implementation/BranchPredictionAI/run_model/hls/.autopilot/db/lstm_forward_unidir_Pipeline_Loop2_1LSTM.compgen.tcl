...
set name run_model_mul_7ns_9ns_15_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler run_model_sparsemux_257_7_16_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename z_4 \
    op interface \
    ports { z_4_address0 { O 5 vector } z_4_ce0 { O 1 bit } z_4_we0 { O 1 bit } z_4_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename z_3 \
    op interface \
    ports { z_3_address0 { O 5 vector } z_3_ce0 { O 1 bit } z_3_we0 { O 1 bit } z_3_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename z_2 \
    op interface \
    ports { z_2_address0 { O 5 vector } z_2_ce0 { O 1 bit } z_2_we0 { O 1 bit } z_2_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename z_1 \
    op interface \
    ports { z_1_address0 { O 5 vector } z_1_ce0 { O 1 bit } z_1_we0 { O 1 bit } z_1_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename z \
    op interface \
    ports { z_address0 { O 5 vector } z_ce0 { O 1 bit } z_we0 { O 1 bit } z_d0 { O 16 vector } } \
} "
} else {
