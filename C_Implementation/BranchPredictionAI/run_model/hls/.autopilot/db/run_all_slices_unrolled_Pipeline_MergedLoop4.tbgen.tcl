set moduleName run_all_slices_unrolled_Pipeline_MergedLoop4
set isTopModule 0
...
set cdfgNum 35
set C_modelName {run_all_slices_unrolled_Pipeline_MergedLoop4}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict merged { MEM_WIDTH 16 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	...
	{ h_slice int 16 regular {array 32 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "merged", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	{ "Name" : "h_slice", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ h_slice_address0 sc_out sc_lv 5 signal 1 } 
	{ h_slice_ce0 sc_out sc_logic 1 signal 1 } 
	{ h_slice_q0 sc_in sc_lv 16 signal 1 } 
	...
	{ grp_fu_291_p_din0 sc_out sc_lv 16 signal -1 } 
	{ grp_fu_291_p_din1 sc_out sc_lv 16 signal -1 } 
	{ grp_fu_291_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_291_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_291_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "grp_fu_291_p_din0", "role": "default" }} , 
 	{ "name": "grp_fu_291_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "grp_fu_291_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_291_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_291_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_291_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_291_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_7_2_16_1_1_U687", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	h_slice { ap_memory {  { h_slice_address0 mem_address 1 5 }  { h_slice_ce0 mem_ce 1 1 }  { h_slice_q0 mem_dout 0 16 } } }
}
