set moduleName run_model_Pipeline_Loop_BN1
set isTopModule 0
...
set cdfgNum 35
set C_modelName {run_model_Pipeline_Loop_BN1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict z1 { MEM_WIDTH 16 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ z1 int 16 regular {array 128 { 0 1 } 3 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "z1", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ z1_address0 sc_out sc_lv 7 signal 0 } 
	{ z1_ce0 sc_out sc_logic 1 signal 0 } 
	{ z1_we0 sc_out sc_logic 1 signal 0 } 
	{ z1_d0 sc_out sc_lv 16 signal 0 } 
	{ z1_address1 sc_out sc_lv 7 signal 0 } 
	{ z1_ce1 sc_out sc_logic 1 signal 0 } 
	{ z1_q1 sc_in sc_lv 16 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "z1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "z1", "role": "address0" }} , 
 	...
 	{ "name": "z1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "z1", "role": "d0" }} , 
 	{ "name": "z1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "z1", "role": "address1" }} , 
 	{ "name": "z1_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "z1", "role": "ce1" }} , 
 	{ "name": "z1_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "z1", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_1_bn_var_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_1_bn_gamma_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	z1 { ap_memory {  { z1_address0 mem_address 1 7 }  { z1_ce0 mem_ce 1 1 }  { z1_we0 mem_we 1 1 }  { z1_d0 mem_din 1 16 }  { z1_address1 MemPortADDR2 1 7 }  { z1_ce1 MemPortCE2 1 1 }  { z1_q1 MemPortDOUT2 0 16 } } }
}
