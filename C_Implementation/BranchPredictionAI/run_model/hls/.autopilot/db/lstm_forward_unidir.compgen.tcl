...
set name run_model_hadd_16ns_16ns_16_5_full_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler run_model_lstm_forward_unidir_c_slice_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler run_model_lstm_forward_unidir_z_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename h_slice \
    op interface \
    ports { h_slice_address0 { O 5 vector } h_slice_ce0 { O 1 bit } h_slice_we0 { O 1 bit } h_slice_d0 { O 16 vector } h_slice_q0 { I 16 vector } } \
} "
} else {
