...
// wrapc file define:
#define AUTOTB_TVIN_y_hat_out "../tv/cdatafile/c.run_model.autotvin_y_hat_out.dat"
#define AUTOTB_TVOUT_y_hat_out "../tv/cdatafile/c.run_model.autotvout_y_hat_out.dat"
...
extern "C"
void run_model_hw_stub_wrapper(void*);

extern "C"
void apatb_run_model_hw(void* __xlx_apatb_param_y_hat_out)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_y_hat_out),
#endif
  };
  port0.param = __xlx_apatb_param_y_hat_out;
  ...
  try {
    ...
    run_model_hw_stub_wrapper(__xlx_apatb_param_y_hat_out);
