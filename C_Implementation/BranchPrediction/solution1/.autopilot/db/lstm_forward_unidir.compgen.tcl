...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename c_last \
    op interface \
    ports { c_last_address0 { O 5 vector } c_last_ce0 { O 1 bit } c_last_we0 { O 1 bit } c_last_d0 { O 32 vector } c_last_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'c_last'"
}
}
