...
set C_modelName {avgpool1d_P.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ Z float 32 regular {array 1152 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.main_fadd_32ns_32ns_32_5_full_dsp_1_U8", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.main_fdiv_32ns_32ns_32_16_1_U9", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15001", "Max" : "15001"}
	, {"Name" : "Interval", "Min" : "15001", "Max" : "15001"}
]}
...
set Spec2ImplPortList { 
	Z { ap_memory {  { Z_address0 mem_address 1 11 }  { Z_ce0 mem_ce 1 1 }  { Z_q0 mem_dout 0 32 } } }
