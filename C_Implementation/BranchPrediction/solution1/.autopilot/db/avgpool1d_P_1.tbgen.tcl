...
set C_modelName {avgpool1d_P.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ Z float 32 regular {array 9216 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ Z_address0 sc_out sc_lv 14 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Z_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "Z", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.main_fadd_32ns_32ns_32_5_full_dsp_1_U89", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.main_fdiv_32ns_32ns_32_16_1_U90", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "71449", "Max" : "71449"}
	, {"Name" : "Interval", "Min" : "71449", "Max" : "71449"}
]}
...
set Spec2ImplPortList { 
	Z { ap_memory {  { Z_address0 mem_address 1 14 }  { Z_ce0 mem_ce 1 1 }  { Z_q0 mem_dout 0 32 } } }
