set moduleName conv1d_valid_dyn_2
set isTopModule 0
...
set C_modelName {conv1d_valid_dyn.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ Y float 32 regular {array 4608 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.X06_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ConvW2_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.main_fadd_32ns_32ns_32_5_full_dsp_1_U75", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.main_fmul_32ns_32ns_32_4_max_dsp_1_U76", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11428129", "Max" : "11428129"}
	, {"Name" : "Interval", "Min" : "11428129", "Max" : "11428129"}
]}
...
set Spec2ImplPortList { 
	Y { ap_memory {  { Y_address0 mem_address 1 13 }  { Y_ce0 mem_ce 1 1 }  { Y_we0 mem_we 1 1 }  { Y_d0 mem_din 1 32 } } }
}
