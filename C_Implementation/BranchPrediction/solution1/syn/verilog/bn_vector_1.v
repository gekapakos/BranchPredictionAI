...
output  [31:0] v_d0;
input  [31:0] v_q0;
output  [6:0] gamma_address0;
output   gamma_ce0;
input  [31:0] gamma_q0;
output  [6:0] beta_address0;
output   beta_ce0;
input  [31:0] beta_q0;
output  [6:0] mean_address0;
output   mean_ce0;
input  [31:0] mean_q0;
output  [6:0] var_address0;
output   var_ce0;
input  [31:0] var_q0;
...
main_faddfsub_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
main_faddfsub_32ns_32ns_32_5_full_dsp_1_U132(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_102_p0),
    .din1(grp_fu_102_p1),
...
main_fmul_32ns_32ns_32_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
main_fmul_32ns_32ns_32_4_max_dsp_1_U133(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln139_fu_127_p2 == 1'd0))) begin
        zext_ln140_reg_152[7 : 0] <= zext_ln140_fu_139_p1[7 : 0];
    end
end
...
assign icmp_ln139_fu_127_p2 = ((c_0_reg_91 == 8'd128) ? 1'b1 : 1'b0);
...
always @ (posedge ap_clk) begin
    zext_ln140_reg_152[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end
