...
wire   [31:0] p_Result_5_fu_188_p3;
reg   [31:0] p_Result_5_reg_327;
...
wire   [0:0] icmp_ln833_3_fu_269_p2;
...
wire   [22:0] tmp_V_1_fu_179_p1;
wire   [31:0] p_Val2_s_fu_157_p1;
wire   [30:0] trunc_ln368_fu_184_p1;
wire   [0:0] icmp_ln833_1_fu_214_p2;
wire   [0:0] grp_fu_134_p2;
wire   [31:0] xor_ln84_fu_239_p2;
wire   [31:0] p_Val2_1_fu_256_p1;
wire   [7:0] tmp_V_2_fu_259_p4;
...
main_faddfsub_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
main_faddfsub_32ns_32ns_32_5_full_dsp_1_U27(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_100_p0),
    .din1(grp_fu_100_p1),
...
main_fmul_32ns_32ns_32_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
main_fmul_32ns_32ns_32_4_max_dsp_1_U28(
    .clk(ap_clk),
    .reset(ap_rst),
...
main_fdiv_32ns_32ns_32_16_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
main_fdiv_32ns_32ns_32_16_1_U29(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_112_p0),
    .din1(grp_fu_112_p1),
...
main_fptrunc_64ns_32_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 32 ))
main_fptrunc_64ns_32_2_1_U30(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(tmp_i_70_reg_389),
    .ce(1'b1),
    .dout(grp_fu_117_p1)
);

main_fpext_32ns_64_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
main_fpext_32ns_64_2_1_U31(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(x_5_reg_371),
    .ce(1'b1),
...
main_dadd_64ns_64ns_64_5_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
main_dadd_64ns_64ns_64_5_full_dsp_1_U33(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(tmp_i_reg_384),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln841_fu_275_p2 == 1'd1) & (icmp_ln833_3_fu_269_p2 == 1'd0))) begin
        expx_reg_58 <= x_5_reg_371;
    end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln833_3_fu_269_p2 == 1'd1))) begin
        expx_reg_58 <= 32'd0;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state62) & (tmp_16_reg_357 == 1'd1) & (icmp_ln849_1_reg_361 == 1'd0) & (1'd0 == and_ln75_reg_348) & (icmp_ln849_reg_344 == 1'd0) & (icmp_ln833_reg_340 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        p_Result_5_reg_327[30 : 0] <= p_Result_5_fu_188_p3[30 : 0];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        tmp_i_70_reg_389 <= grp_fu_129_p2;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state62) & (tmp_16_reg_357 == 1'd1) & (icmp_ln849_1_reg_361 == 1'd0) & (1'd0 == and_ln75_reg_348) & (icmp_ln849_reg_344 == 1'd0) & (icmp_ln833_reg_340 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln841_fu_275_p2 == 1'd0) & (icmp_ln833_3_fu_269_p2 == 1'd0))) begin
...
assign abst_in_fu_196_p1 = p_Result_5_fu_188_p3;

assign and_ln75_fu_220_p2 = (icmp_ln833_1_fu_214_p2 & grp_fu_134_p2);
...
assign grp_fu_124_p0 = p_Result_5_fu_188_p3;

assign grp_fu_134_p2 = ((tmp_V_1_fu_179_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln833_1_fu_214_p2 = ((tmp_V_fu_169_p4 == 8'd72) ? 1'b1 : 1'b0);

assign icmp_ln833_3_fu_269_p2 = ((tmp_V_2_fu_259_p4 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln833_fu_202_p2 = ((tmp_V_fu_169_p4 == 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln841_fu_275_p2 = ((tmp_V_2_fu_259_p4 < 8'd96) ? 1'b1 : 1'b0);

assign icmp_ln849_1_fu_234_p2 = ((tmp_V_reg_322 < 8'd127) ? 1'b1 : 1'b0);

assign icmp_ln849_fu_208_p2 = ((tmp_V_fu_169_p4 < 8'd72) ? 1'b1 : 1'b0);

assign p_Result_5_fu_188_p3 = {{1'd0}, {trunc_ln368_fu_184_p1}};

assign p_Val2_1_fu_256_p1 = x_5_reg_371;
...
assign tmp_V_1_fu_179_p1 = p_Val2_s_fu_157_p1[22:0];

assign tmp_V_2_fu_259_p4 = {{p_Val2_1_fu_256_p1[30:23]}};

assign tmp_V_fu_169_p4 = {{p_Val2_s_fu_157_p1[30:23]}};

assign trunc_ln368_fu_184_p1 = p_Val2_s_fu_157_p1[30:0];

assign x_5_fu_249_p3 = ((icmp_ln849_1_reg_361[0:0] === 1'b1) ? grp_fu_100_p2 : grp_fu_100_p2);

assign xor_ln112_fu_285_p2 = (bitcast_ln112_fu_281_p1 ^ 32'd2147483648);

assign xor_ln84_fu_239_p2 = (p_Result_5_reg_327 ^ 32'd2147483648);

assign xor_ln95_fu_306_p2 = (bitcast_ln95_fu_302_p1 ^ 32'd2147483648);

always @ (posedge ap_clk) begin
    p_Result_5_reg_327[31] <= 1'b0;
