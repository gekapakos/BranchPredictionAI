...
// ==============================================================
#ifndef __main_fptrunc_64ns_32_2_1__HH__
#define __main_fptrunc_64ns_32_2_1__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(main_fptrunc_64ns_32_2_1) {
    ...
    SC_CTOR(main_fptrunc_64ns_32_2_1):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
